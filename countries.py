...
lived_geom = world[world["COUNTRY"].isin(lived_countries)].dissolve(by = "const").geometry.simplify(resolution)
visited_geom = world[world["COUNTRY"].isin(visited_countries)].dissolve(by = "const").geometry.simplify(resolution)
